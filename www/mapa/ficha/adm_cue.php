...
$id=1;
if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0  && $_GET['id'] < 6) {
	$id= $_GET['id'];
}
include_once ("../../amfphp/services/DALInegi.php");
$data = DALInegi::getInstance()->getAdmBasinDetails($id);
$servicesData = DALInegi::getInstance()->getAdmBasinServicesCensus($id);
$details = $data[0];
...
<head>
	...
	<meta charset="utf-8"/>
	<title>Región hidro.-adminiva.</title>
...
<body>
<div class="container">
	<small class="text-muted">Región hidrológico-administrativa</small>
	<small class="label label-default"><?php echo $id;?></small><br>
	<h3 class="page-header"><?php echo utf8_encode($details['cuenca_admva']);?>
