...
$data = DALInegi::getInstance()->getAdmRegionDetails($id);
$servicesData = DALInegi::getInstance()->getAdmRegServicesCensus($id);
$details = $data[0];
...
<head>
	...
	<meta charset="utf-8"/>
	<title>Región administrativa</title>
...
<body>
<div class="container">
	<small class="text-muted">Región administrativa</small>
	<small class="label label-default"><?php echo $id;?></small><br>
	<h3 class="page-header"><?php echo utf8_encode($details['regionAdmiva']);?>
