...
$id=1;
if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0  && $_GET['id'] < 21) {
	$id= $_GET['id'];
}
include_once ("../../amfphp/services/DALInegi.php");
$data = DALInegi::getInstance()->getBasinDetails($id);
$servicesData = DALInegi::getInstance()->getBasinServicesCensus($id);
$details = $data[0];
...
<head>
	...
	<meta charset="utf-8"/>
	<title>Cuenca hidrológica</title>
...
<body>
<div class="container">
	<small class="text-muted">Cuenca hidrológica</small>
	<small class="label label-default"><?php echo $id;?></small><br>
	<h3 class="page-header"><?php echo utf8_encode($details['cuenca']);?></h3>
	Habitantes: <strong>
