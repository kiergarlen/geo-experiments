...
siclabControllers.controller('LoginCtrl', ['$scope', 'Login', function($scope, Login) {
...
siclabControllers.controller('NavCtrl', ['$scope', 'Menu', function($scope, Menu) {
    $scope.menu = Menu.query();
}]);

siclabControllers.controller('TasksCtrl', ['$scope', function($scope) {
...
siclabControllers.controller('QuoteCtrl',
...
siclabControllers.controller('SamplingOrderCtrl',
